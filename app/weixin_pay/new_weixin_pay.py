...
class AvatarWexinPay(object):
    """
    微信支付接口
    """

    def __init__(self):
        self.APP_ID = current_app.config['AVATAR_WX_APP_ID']
        self.MCH_ID = current_app.config['AVATAR_WX_MCH_ID']
        self.MCH_KEY = current_app.config['AVATAR_WX_MCH_KEY']
        self.SPBILL_CREATE_IP = current_app.config['WX_SPBILL_CREATE_IP']
        self.NOTIFY_URL = current_app.config['AVATAR_WX_NOTIFY_URL']
