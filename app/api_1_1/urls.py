...
from .views import GetAuthSmsApi, RegisterApi, UploadMobileInfoApi, FeedBackApi, SetUserInfoApi, UploadExceptionLogApi, \
    ...
    FreeExperienceApi, ExperienceStatusApi, GetTriangleApi, GetFunctionVideoApi, GetMicroStoreUrlApi, GetInviteLinkApi, \
    BiFinishNoticeApi, GetEveryWashUrlApi, CheckIMEIApi, FreeTrialApi, GetHotDotApi, UploadVoiceApi

api_v_1_1 = Blueprint('api_1_1', __name__)
api = Api(api_v_1_1)
...
# 微店铺链接地址获取接口
api.add_resource(GetMicroStoreUrlApi, '/GetMicroStoreUrlApi', endpoint='GetMicroStoreUrlApi')
# 邀请链接获取接口
api.add_resource(GetInviteLinkApi, '/GetInviteLink', endpoint='GetInviteLinkApi')
# 大数据通知bi完成接口
api.add_resource(BiFinishNoticeApi, '/bi_n', endpoint='bi_n')
# 每日一淘接口
api.add_resource(GetEveryWashUrlApi, '/GetEveryWashUrl', endpoint='GetEveryWashUrl')
# IMEI检测接口
api.add_resource(CheckIMEIApi, '/check_imel', endpoint='CheckIMEIApi')
# 免费试用一天
api.add_resource(FreeTrialApi, '/free_trial', endpoint='FreeTrialApi')
# 功能小红点
api.add_resource(GetHotDotApi, '/get_hot_dot', endpoint='GetHotDotApi')
# 语音盒子上传音频
api.add_resource(UploadVoiceApi, '/upload_voice', endpoint='UploadVoiceApi')
