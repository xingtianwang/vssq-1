...
* url: https://**server_addr**/vssq/api/v1.0/ChannelAppUpdate
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/GetCommGroup?g_type=1&app_version=1.0.1&imei=123456789012345
* method: GET
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/GetCh?channel=huawei&imei=123456789012345&app_version=1.0.1
* method: GET
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/GetActivity?app_version=1.0.6&godin_id=429a2d57e70bb09c2080d7b029ab14dc&imei=123456789012345
* method: GET
*  请求消息示例:
...
* url: server_addr/swsd/api/v1.0/ac_func
* method: POST
*  请求消息示例:
    ```
    json_req = {
...
* url: https://**server_addr**/vssq/api/v1.0/we_key?we_key_id=2222222222&user_id=15011329055
* method: GET
*  请求消息示例:
	##### 参数说明:
	```
...
* url: https://**server_addr**/vssq/api/v1.0/m_key
* method: POST
*  请求消息示例:
    ```
    {
...
* url: server_addr/api/v1.0/notice?flag_id=1&app_version=1.0.1&imei=862534031404101
* method: GET
*  请求消息示例:
...
* url: server_addr/api/v1.0/read_notice?imei=123456789012345&notice_id=n20180822163030&app_version=1.0.1
* method: GET
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/ser_pro
...
* url: https://**server_addr**/vssq/api/v1.0/cm_key
* method: POST
*  请求消息示例:
    ```
    {
...
* url: https://**server_addr**/vssq/api/v1.0/ava_b_vip
* http请求头部添加: Authorization: Basic MTUwMTEzMjkwNTU6MTExMTEx(此处为base64编码数据，数据内容为(token值:""))
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/api/v1.0/judge_k
* method: Post
*  请求消息示例:
...
* url: https://**server_addr**/api/v1.0/check_k
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/api/v1.0/check_app
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/api/v1.0/verify
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/buy
* http请求头部添加: Authorization: Basic MTUwMTEzMjkwNTU6MTExMTEx(此处为base64编码数据，数据内容为(token值:""))
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/status
* http请求头部添加: Authorization: Basic MTUwMTEzMjkwNTU6MTExMTEx(此处为base64编码数据，数据内容为(token值:""))
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/ids
* http请求头部添加: Authorization: Basic MTUwMTEzMjkwNTU6MTExMTEx(此处为base64编码数据，数据内容为(token值:""))
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/open_screen
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/open_statistics
* method: POST
*  请求消息示例:
...
* url: server_addr/api/v1.0/n_notice?flag_id=1&app_version=1.0.1&imei=862534031404101
* method: GET
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/f_vip
* http请求头部添加: Authorization: Basic MTUwMTEzMjkwNTU6MTExMTEx(此处为base64编码数据，数据内容为(token值:""))
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/b_assistant
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/b_link
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/vszl_search
* method: post
*  请求消息示例:
    ...
    ```
* url: https://**server_addr**/vssq/api/v1.0/vszl_add
* method: post
*  请求消息示例:
    ```
	{
    ...
    ```
### **68. 免费体验Vip:
* url: https://**server_addr**/vssq/api/v1.0/experience_status
* 获取当前用户是否有免费体验的资格
* method: post
*  请求消息示例:
    ...
    ```
* url: https://**server_addr**/vssq/api/v1.0/free_experience
* 当前用户已体验
* method: post
*  请求消息示例:
    ```
...
* url: https://**server_addr**/vssq/api/v1.0/get_triangle
* method: POST
*  请求消息示例:
...
* url: https://**server_addr**/vssq/api/v1.0/function_video
* method: POST
*  请求消息示例:
